...
//        $post_id = "56cec7d0861a7f3c54ab72fc";    //构建一个postId  闻相如用户
        $post_id = "56b3cd75d043dc9758c429bb";    //构建一个postId  刘老师用户
//        $post_id = "56b3cddad043dc9858a8ae34";    //构建一个postId  刘老师用户4
//        $post_id = "56b3cddbd043dc9858a8ae35";    //构建一个postId  刘老师用户5
//        $post_id = "56b3cddbd043dc9858a8ae36";    //构建一个postId  刘老师用户6
//        $post_id = "56b3cddcd043dc9858a8ae37";    //构建一个postId  刘老师用户7
//        $post_id = "56b3cddcd043dc9858a8ae38";    //构建一个postId  刘老师用户8
        if ($post_id == "") {
            print_r("该帖子已被删除");
//            return;   //origin
            exit;
...
//        $this->view->post_content = str_replace("\n", "<br />", Weiou_Util_Html::htmlspecialchars($postDetail['post_content']));
        ...
        $this->view->pic_file_path = $pic_url;
        $post['thumbnail'] = $pic_url;             //画报内图片的url地址
//        echo $pic_url;
//        exit;
